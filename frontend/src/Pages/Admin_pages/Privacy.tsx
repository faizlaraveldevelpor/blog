...
function Privacy() {
  let [AboutApifnc, { data, isLoading }] = usePrivacy_ApiMutation()
      ...
      <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8'>
        <div>
          <h1 className='text-3xl font-bold text-brand-primary mb-2 flex items-center gap-3'>
            <HiShieldCheck className="text-brand-accent" />
            Privacy Policy
          </h1>
          <p className='text-brand-muted text-sm'>Manage your website's privacy policy and data protection guidelines</p>
        </div>
        <Button
        ...
        <div className='card p-8'>
          <div className='mb-6 pb-4 border-b border-slate-200'>
            ...
            <p className='text-sm text-brand-muted'>
              Outline how you collect, use, and protect user data. Include details about cookies, data storage, and user rights.
            </p>
          </div>
          ...
          <div className='mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg'>
            <h3 className='text-sm font-semibold text-purple-900 mb-2'>🔐 Privacy Policy Essentials</h3>
            <ul className='text-xs text-purple-800 space-y-1'>
              <li>• Clearly explain what data you collect and why</li>
              <li>• Describe how users can access or delete their data</li>
              <li>• Include information about cookies and tracking</li>
              <li>• Mention third-party services and integrations</li>
              <li>• Keep your policy up to date with regulations (GDPR, CCPA, etc.)</li>
            </ul>
          </div>
