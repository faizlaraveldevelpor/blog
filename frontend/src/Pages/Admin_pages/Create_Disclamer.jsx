...
function Create_Disclamer() {
  let [AboutApifnc, { data, isLoading }] = useDisclamer_ApiMutation()
  ...
  let editorJs_function = async () => {
    const editor = editor_js_ref.current = new EditorJS({
      holder: "editorjs",
      placeholder: "Write your Disclaimer here...",
      data: editor_date,
      onReady: () => {
        new DragDrop(editor);
      },
      ...
      <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8'>
        <div>
          <h1 className='text-3xl font-bold text-brand-primary mb-2 flex items-center gap-3'>
            <HiExclamationTriangle className="text-amber-500" />
            Disclaimer
          </h1>
          <p className='text-brand-muted text-sm'>Manage your website's disclaimer and legal notices</p>
        </div>
        <Button
        ...
        <div className='card p-8'>
          <div className='mb-6 pb-4 border-b border-slate-200'>
            ...
            <p className='text-sm text-brand-muted'>
              A disclaimer limits your liability and clarifies the limitations of your content. Be clear about what you're responsible for.
            </p>
          </div>
          ...
          <div className='mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg'>
            <h3 className='text-sm font-semibold text-amber-900 mb-2'>⚠️ Disclaimer Guidelines</h3>
            <ul className='text-xs text-amber-800 space-y-1'>
              <li>• Clarify that content is for informational purposes only</li>
              <li>• Mention limitations of liability for accuracy</li>
              <li>• Include professional advice disclaimers if applicable</li>
              <li>• Address affiliate links or sponsored content</li>
              <li>• Consider consulting with legal professionals for your specific needs</li>
            </ul>
          </div>
